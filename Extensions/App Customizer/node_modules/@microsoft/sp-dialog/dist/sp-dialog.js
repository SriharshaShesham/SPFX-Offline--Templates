define("c0c518b8-701b-4f6f-956d-5782772bb731_1.10.0", ["@microsoft/sp-application-base","@microsoft/office-ui-fabric-react-bundle","@microsoft/sp-core-library","react","react-dom","@microsoft/load-themed-styles","@microsoft/sp-diagnostics","@microsoft/decorators"], function(__WEBPACK_EXTERNAL_MODULE_GPet__, __WEBPACK_EXTERNAL_MODULE_KL1q__, __WEBPACK_EXTERNAL_MODULE_UWqr__, __WEBPACK_EXTERNAL_MODULE_cDcd__, __WEBPACK_EXTERNAL_MODULE_faye__, __WEBPACK_EXTERNAL_MODULE_jOlS__, __WEBPACK_EXTERNAL_MODULE_ut3N__, __WEBPACK_EXTERNAL_MODULE_wxtz__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/*!******************************!*\
  ...
  \******************************/
/*! exports provided: _getInternalDialogApi, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "_getInternalDialogApi", function() { return _getInternalDialogApi; });
...
/* harmony import */ var _AlertDialog__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./AlertDialog */ "3wvS");
/* harmony import */ var _BaseDialog__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./BaseDialog */ "FK5U");
/* harmony import */ var _FabricDialogWrapper__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./FabricDialogWrapper */ "JtmD");
/* harmony import */ var _PromptDialog__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./PromptDialog */ "RE7M");
/* harmony import */ var _SecondaryDialogProvider__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./SecondaryDialogProvider */ "SlWO");
...
var DialogManager = /** @class */ (function () {
    function DialogManager(config) {
        _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_2__["Validate"].isNotNullOrUndefined(config, 'DialogManager Configuration');
        _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_2__["Validate"].isNotNullOrUndefined(config.domElement, 'Dialog Container');
    ...
    Object.defineProperty(DialogManager, "instance", {
        ...
        get: function () {
            if (!this._instance) {
                this._instance = new DialogManager(_microsoft_sp_application_base__WEBPACK_IMPORTED_MODULE_1__["_DialogManagerConfiguration"].instance);
            }
    ...
    DialogManager.prototype.alert = function (message, options) {
        return this.show(new _AlertDialog__WEBPACK_IMPORTED_MODULE_6__["default"](message), options);
    };
    /**
    ...
    DialogManager.prototype.prompt = function (message, options) {
        ...
        this.show(new _PromptDialog__WEBPACK_IMPORTED_MODULE_9__["default"](message, resolve), options);
        return promise;
    };
    Object.defineProperty(DialogManager.prototype, "isShowingDialog", {
         ...
         */
        get: function () {
            return this._activeDialogs.filter(function (d) { return _getInternalDialogApi(d)._state === _BaseDialog__WEBPACK_IMPORTED_MODULE_7__["DialogState"].Open; }).length > 0;
        },
        enumerable: true,
        configurable: true
    });
    ...
    DialogManager.prototype.show = function (dialog, options) {
        var _this = this;
        _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_2__["Validate"].isNotNullOrUndefined(dialog, 'dialog');
        var _dialog = _getInternalDialogApi(dialog);
        var qosMonitor = new _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_3__["_QosMonitor"]('DialogManager.show');
        _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_3__["_TraceLogger"].logVerbose(DialogManager._logSource, 'New request to show a dialog has been submitted.');
        try {
            if (!_dialog._isActive) {
                ...
                var id = _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_2__["Guid"].newGuid();
                this._requests.push({ id: id, dialog: dialog, resolve: resolve_1, reject: reject_1, options: options });
                _dialog._requestAck(id);
                _dialog._setState(_BaseDialog__WEBPACK_IMPORTED_MODULE_7__["DialogState"].Pending);
                ...
                _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_3__["_TraceLogger"].logError(DialogManager._logSource, error);
    ...
    DialogManager.prototype.createSecondaryDialogProvider = function (ownerRequestId) {
        return new _SecondaryDialogProvider__WEBPACK_IMPORTED_MODULE_10__["default"](this, ownerRequestId);
    };
    /**
    ...
    DialogManager.prototype._showSecondary = function (dialog, ownerRequestId, options) {
        _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_2__["Validate"].isNotNullOrUndefined(dialog, 'dialog');
        _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_2__["Validate"].isNotNullOrUndefined(ownerRequestId, 'ownerRequestId');
        var _dialog = _getInternalDialogApi(dialog);
        var qosMonitor = new _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_3__["_QosMonitor"]('DialogManager.showSecondary');
        _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_3__["_TraceLogger"].logVerbose(DialogManager._logSource, 'A request to show a secondary dialog has been submitted.');
        try {
            ...
            if (this._hasPermissionToShow(ownerRequestId)) {
                ...
                _dialog._setState(_BaseDialog__WEBPACK_IMPORTED_MODULE_7__["DialogState"].Approved);
                this._open(dialog);
                return promise;
            }
            else {
    ...
    DialogManager.prototype._abort = function (dialog) {
        ...
        if (dialog && !_dialog._isActive) {
            _dialog._setState(_BaseDialog__WEBPACK_IMPORTED_MODULE_7__["DialogState"].New);
    ...
    DialogManager.prototype._close = function (dialog) {
        ...
        _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_2__["Validate"].isNotNullOrUndefined(dialog, 'dialog');
        var _dialog = _getInternalDialogApi(dialog);
        var qosMonitor = new _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_3__["_QosMonitor"]('DialogManager.close');
        if (_dialog._isActive) {
            // Visually hide the dialog
            var closePromise = this._getUiComponent(dialog).close().then(function () {
                _dialog.onAfterClose();
                _dialog._setState(_BaseDialog__WEBPACK_IMPORTED_MODULE_7__["DialogState"].Closed);
    ...
    Object.defineProperty(DialogManager.prototype, "_pendingRequests", {
        get: function () {
            return this._requests.filter(function (r) { return _getInternalDialogApi(r.dialog)._state === _BaseDialog__WEBPACK_IMPORTED_MODULE_7__["DialogState"].Pending; });
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(DialogManager.prototype, "_hasHiddenDialog", {
        get: function () {
            return this._requests.filter(function (r) { return _getInternalDialogApi(r.dialog)._state === _BaseDialog__WEBPACK_IMPORTED_MODULE_7__["DialogState"].Hidden; }).length > 0;
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(DialogManager.prototype, "_currentlyOpenDialogRequest", {
        get: function () {
            return this._requests.filter(function (r) { return _getInternalDialogApi(r.dialog)._state === _BaseDialog__WEBPACK_IMPORTED_MODULE_7__["DialogState"].Open; })[0];
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(DialogManager.prototype, "_config", {
        get: function () {
            return _microsoft_sp_application_base__WEBPACK_IMPORTED_MODULE_1__["_DialogManagerConfiguration"].instance;
        },
        enumerable: true,
        configurable: true
    });
    ...
    DialogManager.prototype._processNextRequest = function () {
        ...
        var qosMonitor = new _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_3__["_QosMonitor"]('DialogManager.processRequest');
        try {
            for (var _i = 0, _a = this._requests; _i < _a.length; _i++) {
                ...
                if (abort) {
                    ...
                    _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_3__["_TraceLogger"].logVerbose(DialogManager._logSource, message);
                    request.reject(new Error(message));
                    this._abort(request.dialog);
                }
                else if (_dialog._state === _BaseDialog__WEBPACK_IMPORTED_MODULE_7__["DialogState"].Approved ||
                    _dialog._state === _BaseDialog__WEBPACK_IMPORTED_MODULE_7__["DialogState"].Hidden) {
                    this._open(request.dialog);
                }
                else if (_dialog._state === _BaseDialog__WEBPACK_IMPORTED_MODULE_7__["DialogState"].Pending) {
                    if (this._config.allowDialogs) {
                        ...
                        _dialog._setState(_BaseDialog__WEBPACK_IMPORTED_MODULE_7__["DialogState"].Rejected);
    ...
    DialogManager.prototype._hide = function (dialog) {
        var _dialog = _getInternalDialogApi(dialog);
        if (dialog && _dialog._state === _BaseDialog__WEBPACK_IMPORTED_MODULE_7__["DialogState"].Open) {
            // Visually hide the dialog
            this._getUiComponent(dialog).close().then(function () {
                _dialog._setState(_BaseDialog__WEBPACK_IMPORTED_MODULE_7__["DialogState"].Hidden);
            });
        }
    };
    DialogManager.prototype._unhide = function (dialog) {
        var _dialog = _getInternalDialogApi(dialog);
        if (dialog && _dialog._state === _BaseDialog__WEBPACK_IMPORTED_MODULE_7__["DialogState"].Hidden) {
            // Visually hide the dialog
            this._getUiComponent(dialog).open(dialog);
            _dialog._setState(_BaseDialog__WEBPACK_IMPORTED_MODULE_7__["DialogState"].Open);
        }
    };
    ...
    DialogManager.prototype._open = function (dialog) {
        var _this = this;
        var _dialog = _getInternalDialogApi(dialog);
        if (_dialog._state === _BaseDialog__WEBPACK_IMPORTED_MODULE_7__["DialogState"].Hidden) {
            this._unhide(dialog);
            return true;
        }
        if (_dialog._state === _BaseDialog__WEBPACK_IMPORTED_MODULE_7__["DialogState"].Approved) {
            if (this.isShowingDialog && dialog.isSecondary) {
                ...
                if (!this._childUiComponent && this._childDialogDiv) {
                    react_dom__WEBPACK_IMPORTED_MODULE_5__["render"](react__WEBPACK_IMPORTED_MODULE_4__["createElement"](_FabricDialogWrapper__WEBPACK_IMPORTED_MODULE_8__["default"], {
    ...
    DialogManager._logSource = _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_3__["_LogSource"].create('DialogManager');
    __decorate([
...
/* harmony default export */ __webpack_exports__["default"] = (DialogManager);
...
/***/ "01ek":
/*!*******************************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/Dialog/Dialog.styles.js ***!
  \*******************************************************************************************************************************************************************************************************************************/
...
/***/ "15YF":
/*!*****************************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/Dialog/Dialog.base.js ***!
  \*****************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "nv8F");
...
/***/ "2X7w":
/*!*****************************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/Layer/Layer.styles.js ***!
  \*****************************************************************************************************************************************************************************************************************************/
/*! exports provided: getStyles */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "2zVY":
/*!*******************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/Overlay.js ***!
  \*******************************************************************************************************************************************************************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _DialogManager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./DialogManager */ "/mGM");
...
var Dialog = /** @class */ (function () {
    ...
    Dialog.alert = function (message, options) {
        var dialogManager = _DialogManager__WEBPACK_IMPORTED_MODULE_0__["default"].instance;
        return dialogManager ?
...
/* harmony import */ var _BaseDialog__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./BaseDialog */ "FK5U");
...
var AlertDialogReact = /** @class */ (function (_super) {
    ...
    AlertDialogReact.prototype.render = function () {
        ...
        return react__WEBPACK_IMPORTED_MODULE_1__["createElement"](office_ui_fabric_react_lib_components_Dialog__WEBPACK_IMPORTED_MODULE_0__["DialogContent"], { title: 'Alert', subText: this.props.message },
            react__WEBPACK_IMPORTED_MODULE_1__["createElement"](office_ui_fabric_react_lib_components_Dialog__WEBPACK_IMPORTED_MODULE_0__["DialogFooter"], null,
                react__WEBPACK_IMPORTED_MODULE_1__["createElement"](_microsoft_office_ui_fabric_react_bundle__WEBPACK_IMPORTED_MODULE_3__["PrimaryButton"], { onClick: this.props.close, text: 'OK' })));
    };
...
var AlertDialog = /** @class */ (function (_super) {
    ...
    AlertDialog.prototype.render = function () {
        react_dom__WEBPACK_IMPORTED_MODULE_2__["render"](react__WEBPACK_IMPORTED_MODULE_1__["createElement"](AlertDialogReact, {
    ...
    return AlertDialog;
}(_BaseDialog__WEBPACK_IMPORTED_MODULE_4__["default"]));
...
/***/ "4RHQ":
/*!*******************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/Styling.js ***!
  \*******************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "4azF":
/*!*****************************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/utilities/DraggableZone/index.js ***!
  \*****************************************************************************************************************************************************************************************************************************/
...
/***/ "67Sy":
/*!*****************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/Modal.js ***!
  \*****************************************************************************************************************************************************************************************************/
...
/***/ "7Arc":
/*!***************************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/Layer/Layer.base.js ***!
  \***************************************************************************************************************************************************************************************************************************/
...
/***/ "88pY":
/*!*****************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/Layer.js ***!
  \*****************************************************************************************************************************************************************************************************/
...
/***/ "8S/1":
/*!*************************************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/Dialog/DialogFooter.styles.js ***!
  \*************************************************************************************************************************************************************************************************************************************/
/*! exports provided: getStyles */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "Bgjg":
/*!**********************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/Layer/Layer.js ***!
  \**********************************************************************************************************************************************************************************************************************/
...
/***/ "CNvk":
/*!************************************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/Dialog/DialogContent.base.js ***!
  \************************************************************************************************************************************************************************************************************************************/
...
var ContentDiv = /** @class */ (function (_super) {
    ...
    ContentDiv.prototype.render = function () {
        var _this = this;
        return react__WEBPACK_IMPORTED_MODULE_0__["createElement"]("div", { ref: function (element) { return _this._divRef = element; } });
    };
    ContentDiv.prototype.componentDidUpdate = function () {
        if (this.props.innerElement && this._divRef) {
            this._divRef.innerHTML = '';
            this._divRef.appendChild(this.props.innerElement);
        }
    };
    return ContentDiv;
...
/***/ "F+OE":
/*!*************************************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/Dialog/DialogContent.types.js ***!
  \*************************************************************************************************************************************************************************************************************************************/
...
/***/ "FI3s":
/*!**************************************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/Dialog/DialogContent.styles.js ***!
  \**************************************************************************************************************************************************************************************************************************************/
/*! exports provided: getStyles */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!***************************!*\
  !*** ./lib/BaseDialog.js ***!
  \***************************/
/*! exports provided: DialogState, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _DialogManager__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./DialogManager */ "/mGM");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var BaseDialog = /** @class */ (function () {
    ...
    Object.defineProperty(BaseDialog.prototype, "secondaryDialogProvider", {
        ...
        get: function () {
            ...
            if (!this._secondaryDialogProvider && this._requestId) {
                this._secondaryDialogProvider = _DialogManager__WEBPACK_IMPORTED_MODULE_2__["default"].instance.createSecondaryDialogProvider(this._requestId);
            }
    ...
    BaseDialog.prototype.show = function (options) {
        if (_DialogManager__WEBPACK_IMPORTED_MODULE_2__["default"].instance) {
            return _DialogManager__WEBPACK_IMPORTED_MODULE_2__["default"].instance.show(this, options);
        }
        else {
    ...
    BaseDialog.prototype.close = function () {
        if (_DialogManager__WEBPACK_IMPORTED_MODULE_2__["default"].instance) {
            if (this._isActive) {
                ...
                return _DialogManager__WEBPACK_IMPORTED_MODULE_2__["default"].instance._close(this);
            }
            else {
                _DialogManager__WEBPACK_IMPORTED_MODULE_2__["default"].instance._abort(this);
            }
        }
        return Promise.resolve(undefined);
    };
    ...
    BaseDialog.prototype._render = function (container) {
        ...
        if (!this._renderPromise) {
            ...
            this.onBeforeOpen().then(function () {
                ...
                _DialogManager__WEBPACK_IMPORTED_MODULE_2__["default"].instance._rejectOnOpen(_this);
                rejectRender_1();
            });
        }
    ...
    BaseDialog.prototype._setState = function (newState) {
        ...
        _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_1__["_TraceLogger"].logVerboseData({
    ...
    BaseDialog._logSource = _microsoft_sp_diagnostics__WEBPACK_IMPORTED_MODULE_1__["_LogSource"].create('BaseDialog');
    __decorate([
...
/* harmony default export */ __webpack_exports__["default"] = (BaseDialog);
...
/***/ "G0Zq":
/*!*******************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/version.js ***!
  \*******************************************************************************************************************************************************************************************************/
/*! no exports provided */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _uifabric_set_version__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @uifabric/set-version */ "oN+8");
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var office_ui_fabric_react_lib_components_Dialog__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! office-ui-fabric-react/lib/components/Dialog */ "glo3");
/* harmony import */ var office_ui_fabric_react_lib_components_Modal_Modal__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! office-ui-fabric-react/lib/components/Modal/Modal */ "zzdt");
...
/* harmony import */ var _placeHolder_PlaceholderSpinner__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./placeHolder/PlaceholderSpinner */ "LCNA");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! react */ "cDcd");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _ContentDiv__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ContentDiv */ "DTCT");
/* harmony import */ var _DialogManager__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./DialogManager */ "/mGM");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var FabricDialogWrapper = /** @class */ (function (_super) {
    ...
    FabricDialogWrapper.prototype.render = function () {
        var dialogContent = !this.state.isContentReady
            ? react__WEBPACK_IMPORTED_MODULE_4__["createElement"](office_ui_fabric_react_lib_components_Dialog__WEBPACK_IMPORTED_MODULE_0__["DialogContent"], {}, react__WEBPACK_IMPORTED_MODULE_4__["createElement"](_placeHolder_PlaceholderSpinner__WEBPACK_IMPORTED_MODULE_3__["default"], { label: '' }))
            : false;
        if (this.state.dialog) {
            return (react__WEBPACK_IMPORTED_MODULE_4__["createElement"](office_ui_fabric_react_lib_components_Modal_Modal__WEBPACK_IMPORTED_MODULE_1__["Modal"], { isOpen: this.state.isOpen, isBlocking: this.state.dialog._configuration.isBlocking, onDismissed: this._onDismissed, onDismiss: this._closeCallback },
                react__WEBPACK_IMPORTED_MODULE_4__["createElement"](_ContentDiv__WEBPACK_IMPORTED_MODULE_5__["default"], { innerElement: this._detachedElement }),
                dialogContent));
        }
        else {
    ...
    FabricDialogWrapper.prototype.componentDidUpdate = function () {
        ...
        if (this.state.isOpen && this.state.dialog && this._detachedElement) {
            if (!this.state.isContentReady) {
                ...
                Object(_DialogManager__WEBPACK_IMPORTED_MODULE_6__["_getInternalDialogApi"])(this.state.dialog)._render(this._detachedElement).then(function () {
...
/* harmony default export */ __webpack_exports__["default"] = (FabricDialogWrapper);
...
/***/ "LCNA":
/*!***********************************************!*\
  !*** ./lib/placeHolder/PlaceholderSpinner.js ***!
  \***********************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _microsoft_office_ui_fabric_react_bundle__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @microsoft/office-ui-fabric-react-bundle */ "KL1q");
/* harmony import */ var _microsoft_office_ui_fabric_react_bundle__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_microsoft_office_ui_fabric_react_bundle__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _Placeholder_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Placeholder.scss */ "St77");
/**
...
var PlaceholderSpinner = /** @class */ (function (_super) {
    ...
    PlaceholderSpinner.prototype.render = function () {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_1__["createElement"](_microsoft_office_ui_fabric_react_bundle__WEBPACK_IMPORTED_MODULE_2__["Overlay"], { className: 'Placeholder-overlay' },
            react__WEBPACK_IMPORTED_MODULE_1__["createElement"]("div", { className: 'Placeholder-spinnerContainer' }, this.state.showSpinner && react__WEBPACK_IMPORTED_MODULE_1__["createElement"](_microsoft_office_ui_fabric_react_bundle__WEBPACK_IMPORTED_MODULE_2__["Spinner"], { type: _microsoft_office_ui_fabric_react_bundle__WEBPACK_IMPORTED_MODULE_2__["SpinnerType"].large, label: this.props.label }))));
    };
    ...
    PlaceholderSpinner = __decorate([
        _microsoft_decorators__WEBPACK_IMPORTED_MODULE_0__["sealed"]
    ], PlaceholderSpinner);
    return PlaceholderSpinner;
}(react__WEBPACK_IMPORTED_MODULE_1__["Component"]));
/* harmony default export */ __webpack_exports__["default"] = (PlaceholderSpinner);
...
/***/ "Mstc":
/*!***************************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/Modal/Modal.base.js ***!
  \***************************************************************************************************************************************************************************************************************************/
...
/***/ "Nio4":
/*!*******************************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/Dialog/DialogContent.js ***!
  \*******************************************************************************************************************************************************************************************************************************/
...
/***/ "OfIR":
/*!************************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/Dialog/Dialog.js ***!
  \************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _BaseDialog__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./BaseDialog */ "FK5U");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
            ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
...
var PromptDialogReact = /** @class */ (function (_super) {
    ...
    PromptDialogReact.isUseDefaultValueKillSwitchActivated = function () {
        return _microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_3__["_SPKillSwitch"].isActivated(_microsoft_sp_core_library__WEBPACK_IMPORTED_MODULE_3__["Guid"].parse('fdde2259-4142-4bc8-a756-ad9c6ac6c297'), '11/19/2019', 'UseDefaultValueInPromptDialogReact');
    };
    PromptDialogReact.prototype.render = function () {
        var _this = this;
        this._value = this.props.defaultValue;
        // Return the content of the dialog
        return react__WEBPACK_IMPORTED_MODULE_1__["createElement"](office_ui_fabric_react_lib_components_Dialog__WEBPACK_IMPORTED_MODULE_0__["DialogContent"], { title: 'Prompt', subText: this.props.message },
            react__WEBPACK_IMPORTED_MODULE_1__["createElement"](_microsoft_office_ui_fabric_react_bundle__WEBPACK_IMPORTED_MODULE_4__["TextField"], __assign({ componentRef: function (c) { return _this._textElement = c; }, onChange: this._onValueChanged, defaultValue: !PromptDialogReact.isUseDefaultValueKillSwitchActivated() ? this.props.defaultValue : undefined, value: !PromptDialogReact.isUseDefaultValueKillSwitchActivated() ? undefined : this.props.defaultValue, onKeyDown: this._onKeyDown }, { autoFocus: true } /* VSO:391730 Remove this workaround */)),
            react__WEBPACK_IMPORTED_MODULE_1__["createElement"](office_ui_fabric_react_lib_components_Dialog__WEBPACK_IMPORTED_MODULE_0__["DialogFooter"], null,
                react__WEBPACK_IMPORTED_MODULE_1__["createElement"](_microsoft_office_ui_fabric_react_bundle__WEBPACK_IMPORTED_MODULE_4__["Button"], { onClick: this.props.close, text: 'Cancel' }),
                react__WEBPACK_IMPORTED_MODULE_1__["createElement"](_microsoft_office_ui_fabric_react_bundle__WEBPACK_IMPORTED_MODULE_4__["PrimaryButton"], { onClick: this._ok, text: 'OK' })));
    };
...
var PromptDialog = /** @class */ (function (_super) {
    ...
    PromptDialog.prototype.render = function () {
        react_dom__WEBPACK_IMPORTED_MODULE_2__["render"](react__WEBPACK_IMPORTED_MODULE_1__["createElement"](PromptDialogReact, {
            message: this._message,
    ...
    return PromptDialog;
}(_BaseDialog__WEBPACK_IMPORTED_MODULE_5__["default"]));
/* harmony default export */ __webpack_exports__["default"] = (PromptDialog);
...
/***/ "SlWO":
/*!****************************************!*\
  !*** ./lib/SecondaryDialogProvider.js ***!
  \****************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _microsoft_decorators__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @microsoft/decorators */ "wxtz");
/* harmony import */ var _microsoft_decorators__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_microsoft_decorators__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _AlertDialog__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AlertDialog */ "3wvS");
/* harmony import */ var _PromptDialog__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./PromptDialog */ "RE7M");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SecondaryDialogProvider = /** @class */ (function () {
    ...
    SecondaryDialogProvider.prototype.alert = function (message, options) {
        var dialog = new _AlertDialog__WEBPACK_IMPORTED_MODULE_1__["default"](message);
    ...
    SecondaryDialogProvider.prototype.prompt = function (message, options) {
        var resolve = function () { return; };
        var promise = new Promise(function (res) { return resolve = res; });
        var dialog = new _PromptDialog__WEBPACK_IMPORTED_MODULE_2__["default"](message, resolve, options ? options.defaultValue : undefined);
...
/* harmony default export */ __webpack_exports__["default"] = (SecondaryDialogProvider);
...
/***/ "T/ax":
/*!******************************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/Dialog/DialogFooter.js ***!
  \******************************************************************************************************************************************************************************************************************************/
...
/***/ "UJDV":
/*!*********************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/Utilities.js ***!
  \*********************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "UO3J":
/*!************************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/Callout/index.js ***!
  \************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "WEvm":
/*!******************************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/FocusTrapZone/index.js ***!
  \******************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "YCiU":
/*!**********************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/Popup/index.js ***!
  \**********************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "aXYV":
/*!***************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/css-loader/2.0.2_webpack@4.35.3/node_modules/css-loader/dist/cjs.js!C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/postcss-loader/3.0.0/node_modules/postcss-loader/src??postcss!./lib/placeHolder/Placeholder.css ***!
  \***************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "fcBF":
/*!*****************************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/Modal/Modal.styles.js ***!
  \*****************************************************************************************************************************************************************************************************************************/
...
/***/ "glo3":
/*!***********************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/Dialog/index.js ***!
  \***********************************************************************************************************************************************************************************************************************/
...
var content = __webpack_require__(/*! !../../../../common/temp/node_modules/.onedrive.pkgs.visualstudio.com/css-loader/2.0.2_webpack@4.35.3/node_modules/css-loader/dist/cjs.js!../../../../common/temp/node_modules/.onedrive.pkgs.visualstudio.com/postcss-loader/3.0.0/node_modules/postcss-loader/src??postcss!./Placeholder.css */ "aXYV");
...
/***/ "j2/K":
/*!*****************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/css-loader/2.0.2_webpack@4.35.3/node_modules/css-loader/dist/runtime/api.js ***!
  \*****************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "jN8F":
/*!******************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/Fabric.js ***!
  \******************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "jiHw":
/*!***************************************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/utilities/decorators/withResponsiveMode.js ***!
  \***************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "mRDm":
/*!**************************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/Layer/LayerHost.js ***!
  \**************************************************************************************************************************************************************************************************************************/
...
/*!**********************!*\
  !*** ./lib/index.js ***!
  \**********************/
/*! exports provided: Dialog, BaseDialog */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Dialog__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Dialog */ "3bzH");
...
/* harmony import */ var _BaseDialog__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./BaseDialog */ "FK5U");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "BaseDialog", function() { return _BaseDialog__WEBPACK_IMPORTED_MODULE_1__["default"]; });
...
/***/ "n8DK":
/*!*********************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/Icon/index.js ***!
  \*********************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "nACv":
/*!***********************************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/Layer/Layer.notification.js ***!
  \***********************************************************************************************************************************************************************************************************************************/
...
/***/ "nDaQ":
/*!*************************************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/utilities/DraggableZone/DraggableZone.js ***!
  \*************************************************************************************************************************************************************************************************************************************/
...
/***/ "nv8F":
/*!*********************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/tslib/1.9.3/node_modules/tslib/tslib.es6.js ***!
  \*********************************************************************************************************************************/
...
/***/ "oN+8":
/*!*****************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/@uifabric/set-version/7.0.2/node_modules/@uifabric/set-version/lib/index.js ***!
  \*****************************************************************************************************************************************************************/
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _setVersion__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./setVersion */ "rN9w");
...
/***/ "qEgt":
/*!**********************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/Layer/index.js ***!
  \**********************************************************************************************************************************************************************************************************************/
/*! exports provided: Layer, LayerBase, LayerHost */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "rN9w":
/*!**********************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/@uifabric/set-version/7.0.2/node_modules/@uifabric/set-version/lib/setVersion.js ***!
  \**********************************************************************************************************************************************************************/
/*! exports provided: setVersion */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "rp3K":
/*!********************************************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/utilities/DraggableZone/DraggableZone.styles.js ***!
  \********************************************************************************************************************************************************************************************************************************************/
...
/***/ "ugPr":
/*!***********************************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/Dialog/DialogFooter.base.js ***!
  \***********************************************************************************************************************************************************************************************************************************/
...
/***/ "xk/t":
/*!******************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/Button.js ***!
  \******************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "y2VM":
/*!**********************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/Modal/index.js ***!
  \**********************************************************************************************************************************************************************************************************************/
...
/***/ "zzdt":
/*!**********************************************************************************************************************************************************************************************************************!*\
  !*** C:/agent/1/_work/5/s/common/temp/node_modules/.onedrive.pkgs.visualstudio.com/office-ui-fabric-react/7.59.0_b00af71b99b3978738e618b37212a8b6/node_modules/office-ui-fabric-react/lib/components/Modal/Modal.js ***!
  \**********************************************************************************************************************************************************************************************************************/
